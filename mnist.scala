...
object Mnist {
    ...
    private val n_hidden_2: Int = 1024
    private val n_out: Int = 10
    private val lambda: Double = 0.0005
    private val n_epochs: Int = 15

    def main(agrs: Array[String]) {
        val recordMnist = new CSVRecordReader(1, ",")
        recordMnist.initialize(new FileSplit(new File("C://Users//cuongdm30//Downloads//train.csv")))
        val iterator: DataSetIterator = new RecordReaderDataSetIterator(recordMnist, 42000, 0, 10)
